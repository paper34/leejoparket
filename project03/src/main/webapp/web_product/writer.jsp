...
<%-- 메일 타이틀 4종 --%>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">이조박켓</div><p></p>
				         <div><a class="h5 mb-0 font-weight-bold text-gray-800" href="../product/product_list2.do">인기매물</a></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div>
 	...
 	<div class="container">
		<div class="row">
			<form method="post" action="<c:url value="/product/product_create.do" />" >
			<div class="head">
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; width:1100px;">
					<thead>
						<tr>
							<th colspan="2"	style="background-color: #4e73df; text-align: center; color:white; width:100%;">상품 등록</th>
						</tr>
					</thead>
						<tbody>
							<tr>
								<td><input type="file" class="form-control" placeholder="이미지" name="product_image" maxlength="50" value="상품이미지" required/></td>
							</tr>
							<tr>
								<td><input type="text" class="form-control" placeholder="글 제목" name="product_title" maxlength="50" required/></td>
							...
							<tr>
								<td>
								<select class="form-control" name="product_adress" id="product_adress" required>
							...
							<tr>
								<td><input type="text" class="form-control" placeholder="가격" name="product_price" maxlength="50" required/></td>
							</tr>
							<tr>
								<td><textarea class="form-control" placeholder="글 내용" name="product_content" maxlength="2048" style="height: 350px;" required></textarea></td>
							</tr>
						</tbody>
				</table>	
			</div>
						
							<input id="b1" style="background-color: #4e73df; float: left; margin: 5px;" type="submit" class="btn btn-primary pull-right" value="상품등록" />
						</form>
							...
							<div id="right_zzim">
								...
								<div> 
									<c:forEach var="vo" items="${list3}" ><%-- 컨트롤러에서 list3을 불러와 foreach문을 사용하여 뿌려줌  --%>
										...
										<div><a href="../product/product_view.do?product_id=${vo.product_id}">LeeJoBak ket</a></div> <%-- 상품 이미지 불러옴 --%> 
									</c:forEach>
								</div>
								<ul></ul> 
								<!-- 본 상품이 뿌려질 부분  -->
