...
<jsp:include page="../../../layout.jsp"></jsp:include>
	...
	<%-- 상품리스트 보여주는 화면 나이별 --%>
  	 <div class="row">
		...
		<c:forEach var="puvo" items="${list4}"><%-- 컨트롤러에서 list를 불러와 foreach문을 사용하여 뿌려줌 --%>
      		 <div class="col-xl-8">
              <div class="card shadow mb-4">
                       <!-- <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="resources/img/1.jpg" alt=""> -->
                 <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem; height: 25rem; dlspaly:block; margin:0 auto;" src="../resources/img/${puvo.product_image}"> 
                 <%--      <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem; dlspaly:block; margin:0 auto;" src="${vo.product_image}"> --%>
                  <h3 class="m-0 font-weight-bold text-primary"><a href="product_view.do?product_id=${puvo.product_id}">LeeJoBak ket</a></h3>
                <%--  <div class="h5 mb-0 font-weight-bold text-gray-800">${vo.product_id}</div> --%>
                  <div class="h4 mb-0 font-weight-bold text-black-1000">${puvo.product_title}</div>
                <%--   <div class="h5 mb-0 font-weight-bold text-gray-800">${vo.product_content}</div> --%>
                  <div class="h4 mb-0  font-weight-bold text-black-800">${puvo.product_price}</div>
                  <div class="h4 mb-0  text-black-800">${puvo.product_adress}</div>
                  <div class="h5 mb-0  text-black-800">${puvo.product_category}</div>
                  <div class="h5 mb-0  text-black-800">
                  ${vo.product_date}
                  <%-- <fmt:formatDate value="${vo.product_date}" pattern="yyyy-MM-dd HH:mm:ss"/> --%>
                  </div>
                  <div class="h6 mb-0 font-weight-bold text-gray-1000">${puvo.product_count}</div>
